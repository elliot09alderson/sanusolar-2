      ...
      <div className="flex flex-col justify-center items-center gap-6 ">
        ...
        <div className=" w-full flex lg:flex-row flex-col items-center lg:px-40 px-[20px]   pt-20 justify-between gap-20">
          <div className="flex  w-full gap-10 relative justify-end">
            ...
            <div className="absolute rounded-lg lg:flex hidden   h-40 right-60 shadow-lg bottom-20 ">
              <img
              ...
              <div className="lg:flex hidden flex-col gap-3 absolute  left-0 top-0 p-3">
                <h1>Solar Energy</h1>
